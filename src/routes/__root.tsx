...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumina — A beautiful place to write, reflect and remember" },
      { name: "description", content: "A beautiful place to write, reflect and remember. Notes, journals, letters and memories, kept softly." },
      { name: "author", content: "Lumina" },
      { name: "application-name", content: "Lumina" },
      { name: "theme-color", content: "#1a1033" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "Lumina" },
      ...
      { property: "og:title", content: "Lumina — A beautiful place to write, reflect and remember" },
      { property: "og:description", content: "A beautiful place to write, reflect and remember. Notes, journals, letters and memories, kept softly." },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://heart-warming-magic.lovable.app/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "Lumina — a beautiful place to write, reflect and remember" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Lumina — A beautiful place to write, reflect and remember" },
      { name: "twitter:description", content: "A beautiful place to write, reflect and remember. Notes, journals, letters and memories, kept softly." },
      { name: "twitter:image", content: "https://heart-warming-magic.lovable.app/og-image.png" },
      { name: "twitter:image:alt", content: "Lumina — a beautiful place to write, reflect and remember" },
    ],
    links: [
      ...
      { rel: "mask-icon", href: "/apple-touch-icon.png", color: "#1a1033" },
